...
<main class="flex-1 flex flex-col md:flex-row">
    ...
    <div class="relative md:w-[42%] overflow-hidden flex flex-col justify-between p-8 md:p-12 bg-black border-b md:border-b-0 md:border-r border-white/8 min-h-55 md:min-h-0">
        ...
        <div class="relative z-10 py-6 md:py-0">
            <p class="text-yellow-500 text-[10px] font-valo font-semibold tracking-[0.3em] uppercase mb-2">
            ...
            <h1 class="font-valo font-bold text-4xl md:text-5xl tracking-[0.06em] leading-none mb-6">
                NOUVEAU<br><span class="text-yellow-500">SUCCÈS</span>
            </h1>
            <div class="w-8 h-px bg-yellow-500/40 mb-5"></div>
            <p class="text-white/35 text-xs leading-relaxed max-w-xs">
                Définissez un succès que les joueurs pourront débloquer depuis la fiche du jeu.
            </p>
        </div>

        <!-- Status -->
        <div class="relative z-10 flex items-center gap-2">
            <i data-lucide="trophy" class="w-3.5 h-3.5 text-yellow-500/40"></i>
    ...
    <div class="flex-1 flex items-center justify-center p-8 md:p-12 lg:p-16">
        <div class="w-full max-w-lg">
            ...
            <form method="POST" action="/games/<?= $game->id ?>/achievements" class="space-y-5">

                <div class="space-y-1.5">
                    <label for="name" class="block text-[11px] font-valo font-semibold uppercase tracking-[0.2em] text-white/70">
                        Nom du succès <span class="text-valo-red">*</span>
                    </label>
                    <input type="text" id="name" name="name" required placeholder="ex: Premier sang"
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea id="description" name="description" rows="4"
                              placeholder="Comment débloquer ce succès…"
                              class="w-full bg-black border border-white/10 hover:border-white/25 focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500/20 outline-none px-4 py-3 text-sm transition-colors duration-150 resize-none"></textarea>
                </div>
