...
<body class="bg-valo-dark text-white min-h-screen flex flex-col select-none">
    ...
    <nav
        class="border-b border-white px-4 sm:px-10 py-4 flex items-center justify-between sticky top-0 z-50 bg-valo-dark/95 backdrop-blur-sm">
    ...
    <main class="flex-1 px-4 sm:px-8 md:px-16 py-8 md:py-14">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-3xl">
            ...
            <a href="/admin/users"
                ...
                <div
                    class="absolute top-0 right-0 w-36 h-36 bg-yellow-500/5 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:bg-yellow-500/10 transition-colors duration-300 pointer-events-none">
                </div>
                <div class="flex items-start justify-between relative z-10">
                    <div
                        class="border border-yellow-500/30 rounded-xl p-3 bg-yellow-500/10 group-hover:bg-yellow-500/20 transition-colors">
                        <i data-lucide="shield" class="w-6 h-6 text-yellow-400"></i>
                    </div>
                    <span
                        class="text-[10px] font-valo tracking-[0.2em] uppercase text-yellow-500/40 group-hover:text-yellow-500/70 transition-colors mt-1">ADMIN
                        //</span>
                </div>
                ...
                <div class="flex items-center justify-between relative z-10 pt-3 border-t border-white/5">
                    <span class="text-[11px] font-valo tracking-widest text-white/30"><?= $totalUsers ?> agents ·
                        <?= $totalAdmins ?> admins</span>
                    <div
                        class="flex items-center gap-1.5 leading-none text-[11px] font-valo tracking-widest text-yellow-500/50 group-hover:text-yellow-400 uppercase transition-colors">
                        Accéder <i data-lucide="arrow-big-right"
                            class="w-3.5 h-3.5 shrink-0 group-hover:translate-x-1 transition-transform duration-200"></i>
                    </div>
                </div>
            </a>
            ...
            <a href="/admin/games"
                ...
                <div
                    class="absolute top-0 right-0 w-36 h-36 bg-valo-red/5 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:bg-valo-red/10 transition-colors duration-300 pointer-events-none">
                </div>
                <div class="flex items-start justify-between relative z-10">
                    <div
                        class="border border-valo-red/30 rounded-xl p-3 bg-valo-red/10 group-hover:bg-valo-red/20 transition-colors">
                        <i data-lucide="gamepad-2" class="w-6 h-6 text-valo-red"></i>
                    </div>
                    <span
                        class="text-[10px] font-valo tracking-[0.2em] uppercase text-valo-red/40 group-hover:text-valo-red/70 transition-colors mt-1">MISSIONS
                        //</span>
                </div>
                <div class="relative z-10">
                ...
                <div class="flex items-center justify-between relative z-10 pt-3 border-t border-white/5">
                    <span class="text-[11px] font-valo tracking-widest text-white/30"><?= $totalGames ?> jeux ·
                        <?= $totalAch ?> succès</span>
                    <div
                        class="flex items-center gap-1.5 leading-none text-[11px] font-valo tracking-widest text-valo-red/50 group-hover:text-valo-red uppercase transition-colors">
                        Accéder <i data-lucide="arrow-big-right"
                            class="w-3.5 h-3.5 shrink-0 group-hover:translate-x-1 transition-transform duration-200"></i>
                    </div>
                </div>
